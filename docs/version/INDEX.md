...
| 迭代 | 标题 | 状态 | 文档 | 创建日期 |
|------|------|------|------|---------|
| v0.8 | Auto-adopt Reflow（后加 repo 能重分类已兜底 LocalSkill） | SHIPPED（单 PR） | [v0.8-bootstrap-reflow.md](./v0.8-bootstrap-reflow.md) | 2026-04-23 |
| v0.7 | Local Skills as First-Class Citizens | SHIPPED (PR1–PR6)；评审见 [_REVIEW](./v0.7-local-skills_REVIEW.md) | [v0.7-local-skills.md](./v0.7-local-skills.md) | 2026-04-22 |
| v0.6 | Open-source 镜像卫生 + Resolve 路径自愈 + 日志落盘 | SHIPPED (PR1–PR5)；评审见 [_REVIEW](./v0.6-mirror-hygiene_REVIEW.md)、[_CR](./v0.6-mirror-hygiene_CR.md) | [v0.6-mirror-hygiene.md](./v0.6-mirror-hygiene.md) | 2026-04-22 |
