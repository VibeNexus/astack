...
| 迭代 | 标题 | 状态 | 文档 | 创建日期 |
|------|------|------|------|---------|
| v0.7 | Local Skills as First-Class Citizens | Spec v1.1 — ready for PR1（Review 反馈已应用）；评审见 [Iteration0.7_LocalSkills_REVIEW](./Iteration0.7_LocalSkills_REVIEW.md) | [v0.7-local-skills.md](./v0.7-local-skills.md) | 2026-04-22 |
| v0.6 | Open-source 镜像卫生 + Resolve 路径自愈 + 日志落盘 | SHIPPED (PR1–PR5)；评审见 [_REVIEW](./v0.6-mirror-hygiene_REVIEW.md) | [v0.6-mirror-hygiene.md](./v0.6-mirror-hygiene.md) | 2026-04-22 |
